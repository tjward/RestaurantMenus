...
engine = create_engine('sqlite:///restaurantmenutest.db')
...
# Create a dummy user
User1 = User(name="TJ", email = "tjward13@gmail.com",
            picture='https://scontent.xx.fbcdn.net/hprofile-xtf1/v/t1.0-1/p200x200/11988333_10204288831169141_7824489665292654083_n.jpg?oh=34d4229f5489479a701b1940e0559731&oe=56BF65C1')
session.add(User1)
session.commit() 
...
restaurant1 = Restaurant(name = "Panda Garden", user = User1)
...
restaurant1 = Restaurant(name = "Thyme for That Vegetarian Cuisine ", user = User1)
...
#Menu for Andala's 
restaurant1 = Restaurant(name = "Andala\'s", user = User1)
...
restaurant1 = Restaurant(name = "Auntie Ann\'s Diner' ", user = User1)
...
restaurant1 = Restaurant(name = "Cocina Y Amor ", user = User1)
...
restaurant1 = Restaurant(name = "State Bird Provisions", user = User1)
session.add(restaurant1)
session.commit()
